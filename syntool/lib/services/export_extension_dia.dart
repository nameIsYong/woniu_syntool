...
//糖尿病随访模块
extension ExportDiaExtension on ExportDataService {
  // 导出糖尿病随访数据
  static Future<ImportDataResponse> httpExportDiaDatas({
    ...
    result = await ExportDiaExtension.httpExportNotSynDiaDatas(
      pageIndex: 1,
  ...
  // 导出未同步的糖尿病数据
  static Future<ImportDataResponse> httpExportNotSynDiaDatas({
    ...
    try {
      ...
      var formBody = params.entries
          ...
          .join('&');
      var apiPath =
          'http://bmg.2woniu.cn/bmanage/publichealth/service/record/4/list';
      ...
      if (jsonResponse['status'] == 0) {
        ...
        for (var item in results) {
          ...
          userData.moduleType = ModuleType.kDiabetes;
