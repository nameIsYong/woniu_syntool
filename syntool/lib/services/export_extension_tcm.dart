...
//中医辨识模块
extension ExportTCMExtension on ExportDataService {
  // 导出中医辨识数据
  static Future<ImportDataResponse> httpExportTCMDatas({
    ...
    result = await ExportTCMExtension.httpExportNotSynTCMDatas(
      pageIndex: 1,
  ...
  // 导出未同步的糖尿病数据
  static Future<ImportDataResponse> httpExportNotSynTCMDatas({
    ...
    try {
      ...
      var formBody = params.entries
          ...
          .join('&');
      var apiPath =
          'http://bmg.2woniu.cn/bmanage/publichealth/service/record/5/list';
      ...
      if (jsonResponse['status'] == 0) {
        ...
        for (var item in results) {
          ...
          userData.moduleType = ModuleType.kTCM;
